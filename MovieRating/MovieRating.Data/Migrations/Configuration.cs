namespace MovieRating.Data.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<MovieRating.Data.MovieRatingContext>
    {
        ...
        protected override void Seed(MovieRatingContext context)
        {
            //  create genres
